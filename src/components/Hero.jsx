...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-[url('https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&q=80&w=2000')] bg-no-repeat bg-center bg-cover text-white pt-[80px]" id="home">
      ...
      <div className="relative z-[2] max-w-7xl mx-auto px-5 md:px-8 w-full">
        <motion.div
        ...
        >
          ...
          <h1 className="text-[clamp(2.5rem,6vw,4rem)] mb-6 leading-[1.1] font-bold font-heading">{t('hero.title')}</h1>
          <p className="text-[clamp(1rem,2vw,1.25rem)] opacity-90 mb-10 max-w-[500px]">{t('hero.subtitle')}</p>
